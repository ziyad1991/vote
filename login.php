...
<style>
  ...
  .bg-gradient-primary {
    ...
    background-image: linear-gradient(180deg,#f68b1f 10%,#224abe 100%);
    background-size: cover;
</style>
  <title>Tay Audit - Login</title>
                ...
                <div class="p-5">
                  ...
                  <form class="user" action="" method="post">
                    <div class="form-group">
                      <input name="name" type="text" class="form-control form-control-user"  placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
